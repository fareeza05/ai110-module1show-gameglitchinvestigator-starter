...
#FIX: Reset state status to 'playing' and cleared history & fix difficulty range
if new_game:
...
if submit:
    ...
    if not ok:
        ...
        # FIX: Removed alternating logic and ensured secret is always int using agent mode
        ...
        if outcome == "Win":
            ...
            #FIX: Checked if user is out of attempts before incrementing
